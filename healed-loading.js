// HEALED LOADING SCREEN
function triggerHealedLoading() {
    const overlay = document.getElementById('healed-loading-overlay');
    const title = overlay.querySelector('.loading-title');
    const subtext = document.getElementById('healed-loading-subtext');
    ...
    // Cycle text messages
    const messages = [
        "Initializing Wellness AI...",
        "Loading Cognitive Tests...",
        "Connecting Neural Pathways...",
        "Preparing Support Interface..."
    ];
    let msgIdx = 0;
    ...
    setTimeout(() => {
        ...
        window.location.href = 'healed.html';
    }, 2800);
}
